...
const BottomNavBar = () => {
  ...
  return (
    <nav
      className="lg:hidden fixed bottom-3 left-1/2 -translate-x-1/2 w-[94%] max-w-sm z-[60] pointer-events-none"
    ...
    >
      ...
      <div className="
        ...
        rounded-2xl shadow-[0_12px_40px_-12px_rgba(0,0,0,0.25)]
        p-1 px-1.5
