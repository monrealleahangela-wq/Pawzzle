        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
          <div className="md:col-span-8 relative group">
            ...
            <input
              ...
              className="w-full pl-20 pr-4 py-5 bg-slate-800 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-3xl outline-none focus:ring-2 focus:ring-primary-500/50 placeholder:text-slate-600 transition-all"
              onChange={(e) => {
          ...
          <div className="md:col-span-4 relative">
             ...
             <select
                ...
                className="w-full h-full bg-slate-800 border-none text-white text-[10px] font-black uppercase tracking-widest rounded-3xl pl-20 pr-10 py-5 outline-none focus:ring-2 focus:ring-primary-500/50 appearance-none transition-all cursor-pointer"
             >
