...
const StoreApplications = () => {
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-slate-900 p-2 rounded-xl shadow-xl border border-white/5 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
          ...
          <div className="md:col-span-4 relative">
             ...
             <select
                ...
                className="w-full h-full bg-slate-800 border-none text-white text-[10px] font-black tracking-widest rounded-xl pl-12 pr-10 py-3 outline-none focus:ring-2 focus:ring-primary-500/50 appearance-none transition-all cursor-pointer"
             >
      ...
      {applications.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {applications.map((app) => {
            ...
            return (
              <div key={app._id} className="group bg-white border border-slate-100 rounded-xl p-8 shadow-sm hover:shadow-2xl transition-all relative overflow-hidden flex flex-col">
                ...
                <div className="w-14 h-14 bg-slate-50 rounded-xl flex items-center justify-center mb-6 group-hover:bg-primary-600 group-hover:text-white transition-all shadow-inner">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-3 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-primary-600 transition-all shadow-xl flex items-center justify-center gap-2"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-8">
                  <div className="bg-slate-50 rounded-xl p-8 border border-slate-100 flex flex-col items-center justify-center text-center">
                    <div className="w-32 h-32 bg-white rounded-xl p-2 border-4 border-slate-100 shadow-inner mb-4 overflow-hidden">
                ...
                <div className="space-y-8">
                  <div className="bg-white border border-slate-100 rounded-xl p-8 shadow-sm">
                    ...
                    <div className="space-y-4">
                      <div className="p-5 bg-slate-900 rounded-xl text-white relative overflow-hidden">
                ...
                <div className="md:col-span-2 space-y-6">
                  <div className="bg-slate-900/5 rounded-xl p-10 border border-slate-100 mt-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      {selectedApplication.mayorsPermitUrl && (
                        <a 
                          ...
                          className="flex items-center justify-between p-6 bg-white rounded-xl border border-slate-100 hover:border-primary-500 hover:shadow-xl transition-all group/doc"
                        >
              ...
              <div className="p-10 bg-white border-t border-slate-100 relative z-10 space-y-8 shadow-[0_-20px_50px_rgba(0,0,0,0.05)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <button
                    ...
                    className="py-6 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.1em] hover:bg-emerald-600 transition-all shadow-xl flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="py-6 bg-amber-500 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.1em] hover:bg-amber-600 transition-all shadow-xl flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="py-6 bg-rose-600 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.1em] hover:bg-rose-700 transition-all shadow-xl flex items-center justify-center gap-2"
                  >
                    <X className="h-4 w-4" /> Reject
                  </button>
                </div>

                <div className="bg-rose-50/50 p-8 rounded-xl border border-rose-100/50 mt-4">
                  ...
                  <input 
                    type="text"
                    className="w-full bg-white border border-rose-100 rounded-xl px-6 py-3 text-sm font-bold placeholder:text-rose-200 outline-none focus:border-rose-400"
                    placeholder=""
