                  ...
                  <div className="bg-slate-900/5 rounded-2xl p-10 border border-slate-100 mt-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      {selectedApplication.mayorsPermitUrl && (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="p-3 bg-amber-100 text-amber-700 rounded-2xl group-hover/doc:bg-amber-600 group-hover/doc:text-white transition-colors">
                      ...
                      {selectedApplication.barangayClearanceUrl && (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="p-3 bg-amber-50 text-amber-600 rounded-2xl group-hover/doc:bg-amber-600 group-hover/doc:text-white transition-colors">
