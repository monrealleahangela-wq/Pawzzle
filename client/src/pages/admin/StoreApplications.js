...
const StoreApplications = () => {
  ...
  return (
    <div className="space-y-6 pb-20">
      <header>
        <p className="text-[10px] font-bold uppercase tracking-wider text-primary-600">Store Verification</p>
      ...
      <div className="bg-slate-900 p-2 rounded-2xl shadow-xl border border-white/5 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
          <div className="md:col-span-6 relative group">
            ...
            <input
              type="text"
              placeholder="Search business name, type, or ID"
      ...
      <div className="flex gap-4 mb-2">
        <div className="px-4 py-2 bg-slate-100 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-500">
          Applications: <span className="text-slate-900">{applications.length} shown</span>
        </div>
      </div>
                  ...
                  <div className="bg-white border border-slate-100 rounded-2xl p-8 shadow-sm">
                    ...
                    <div className="space-y-4">
                      <div className="p-5 bg-slate-900 rounded-2xl text-white relative overflow-hidden">
                        ...
                        <p className="text-[8px] font-black text-primary-400 uppercase tracking-wider mb-3">Bank Transfer Details</p>
                  ...
                  <div className="bg-slate-900/5 rounded-2xl p-10 border border-slate-100 mt-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      {selectedApplication.mayorsPermitUrl && (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="p-3 bg-secondary-100 text-primary-700 rounded-2xl group-hover/doc:bg-primary-600 group-hover/doc:text-white transition-colors">
                          ...
                          <ExternalLink className="h-4 w-4 text-slate-300 group-hover/doc:text-primary-600 transition-all" />
                        </a>
                      )}
                      ...
                      {(selectedApplication.governmentIdUrl || selectedApplication.verification?.idImage) && (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="p-3 bg-emerald-50 text-emerald-600 rounded-2xl group-hover/doc:bg-emerald-600 group-hover/doc:text-white transition-colors">
                      ...
                      {selectedApplication.businessRegistrationUrl && (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="p-3 bg-indigo-50 text-indigo-600 rounded-2xl group-hover/doc:bg-indigo-600 group-hover/doc:text-white transition-colors">
                      ...
                      {selectedApplication.birRegistrationUrl && (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="p-3 bg-rose-50 text-rose-600 rounded-2xl group-hover/doc:bg-rose-600 group-hover/doc:text-white transition-colors">
                      ...
                      {selectedApplication.barangayClearanceUrl && (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="p-3 bg-secondary-50 text-primary-600 rounded-2xl group-hover/doc:bg-primary-600 group-hover/doc:text-white transition-colors">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {CORRECTION_OPTIONS.map(opt => (
                        <button
                          ...
                          className={`px-2.5 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest border transition-all ${reviewForm.requiredCorrections?.includes(opt.id) ? 'bg-primary-600 border-primary-600 text-white' : 'bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100'}`}
                        >
                          {opt.label}
                        </button>
                      ))}
                  ...
                  <div className="lg:col-span-7 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                      ...
                      <button
                        ...
                        className="py-3.5 bg-secondary-500 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.1em] hover:bg-primary-600 transition-all shadow-sm flex items-center justify-center gap-2"
                      >
