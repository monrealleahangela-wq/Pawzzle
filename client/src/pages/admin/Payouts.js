            ...
            <div className="max-w-6xl mx-auto space-y-4">
                ...
                <div className="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p className="text-slate-500 text-xs font-medium mt-0.5">Review and process seller payout requests.</p>
                    </div>
                            ...
                            return (
                                <div key={payout._id} className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                                    <button
                                        ...
                                        className="w-full flex flex-wrap sm:flex-nowrap items-center gap-3 p-4 hover:bg-slate-50 transition-all text-left"
                                    >
