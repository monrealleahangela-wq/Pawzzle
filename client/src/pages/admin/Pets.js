  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-4 sm:p-8 space-y-8">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 bg-white p-6 sm:p-10 rounded-[3rem] border border-slate-100 shadow-sm relative overflow-hidden">
        ...
        <button onClick={handleOpenModal} className="px-8 py-3.5 bg-slate-900 text-white rounded-xl text-[11px] font-black uppercase tracking-[0.2em] hover:bg-rose-500 transition-all shadow-xl shadow-slate-200 flex items-center gap-3 group">
          ...
          <div className="bg-white w-full max-w-5xl rounded-[3rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
                ...
                <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="text" required value={petForm.name} onChange={e => setPetForm(p => ({ ...p, name: e.target.value }))}
                      className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-[13px] font-black uppercase outline-none focus:ring-2 focus:ring-rose-400/20" placeholder="PET NAME..." />
                  </div>
                  {/* Row 2: Species + Breed */}
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <select value={petForm.species} onChange={e => setPetForm(p => ({ ...p, species: e.target.value }))}
                        className="w-full px-4 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-[11px] font-black uppercase outline-none appearance-none cursor-pointer">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input type="text" required value={petForm.breed} onChange={e => setPetForm(p => ({ ...p, breed: e.target.value }))}
                        className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-[11px] font-black uppercase outline-none" placeholder="E.G. GOLDEN RETRIEVER" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-12 gap-4">
                    <div className="col-span-6 space-y-1.5">
                      ...
                      <input type="number" required value={petForm.price} onChange={e => setPetForm(p => ({ ...p, price: e.target.value }))}
                        className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-lg font-black outline-none" placeholder="0.00" />
                    </div>
                    <div className="col-span-3 space-y-1.5">
                      ...
                      <input type="number" required value={petForm.age} onChange={e => setPetForm(p => ({ ...p, age: e.target.value }))}
                        className="w-full px-4 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-lg font-black outline-none text-center" placeholder="0" />
                    </div>
                    <div className="col-span-3 space-y-1.5">
                      ...
                      <select value={petForm.ageUnit} onChange={e => setPetForm(p => ({ ...p, ageUnit: e.target.value }))}
                        className="w-full px-3 py-3.5 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase outline-none appearance-none cursor-pointer text-center">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input type="text" value={petForm.color} onChange={e => setPetForm(p => ({ ...p, color: e.target.value }))}
                      className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-[11px] font-black uppercase outline-none" placeholder="E.G. GOLDEN, BLACK, TRI-COLOR..." />
                  </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {['male', 'female'].map(g => (
                          <button key={g} type="button" onClick={() => setPetForm(p => ({ ...p, gender: g }))}
                            className={`py-3.5 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all border-2 ${petForm.gender === g ? 'bg-rose-500 border-rose-400 text-white shadow-lg' : 'bg-slate-50 border-slate-100 text-slate-400 hover:border-rose-200'}`}>
                            {g}
                          </button>
                        ))}
                      </div>
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        {[{ v: 'small', l: 'S' }, { v: 'medium', l: 'M' }, { v: 'large', l: 'L' }, { v: 'extra_large', l: 'XL' }].map(s => (
                          <button key={s.v} type="button" onClick={() => setPetForm(p => ({ ...p, size: s.v }))}
                            className={`py-3.5 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all border-2 ${petForm.size === s.v ? 'bg-slate-900 border-slate-800 text-white shadow-lg' : 'bg-slate-50 border-slate-100 text-slate-400 hover:border-slate-300'}`}>
                            {s.l}
                          </button>
                        ))}
                      </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea required value={petForm.description} onChange={e => setPetForm(p => ({ ...p, description: e.target.value }))}
                      className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-[12px] font-medium leading-relaxed outline-none h-28 resize-none" placeholder="Tell customers about this pet..." />
                  </div>
                </div>
              )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full px-6 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-[12px] h-32 resize-none outline-none focus:ring-2 focus:ring-rose-500/10"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-4">
                        <input
                          ...
                          className="w-full px-6 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-[11px] font-black uppercase outline-none"
            ...
            <footer className="p-8 bg-white border-t border-slate-50 flex gap-4 shrink-0 relative z-20">
              <button type="button" onClick={() => { setShowAddForm(false); setEditingPet(null); }}
                className="px-10 py-3.5 bg-slate-50 text-slate-400 rounded-xl text-[11px] font-black uppercase tracking-widest hover:bg-slate-100 transition-all active:scale-95">
                Cancel
              </button>
