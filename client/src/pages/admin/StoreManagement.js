    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
        <div className="bg-white p-12 rounded-[3rem] shadow-2xl text-center max-w-lg">
          ...
          <button onClick={handleInitialize} className="w-full py-3.5 bg-slate-900 text-white rounded-xl font-black uppercase">Create Store Profile</button>
        </div>
      </div>
    );
  }
                ...
                <div className="space-y-12 animate-in fade-in slide-in-from-right-12 duration-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <input type="text" name="name" value={store.name || ''} onChange={handleInputChange} className="w-full px-6 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-indigo-500 focus:bg-white outline-none font-bold transition-all" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Business Type</label>
                      <select name="businessType" value={store.businessType || ''} onChange={handleInputChange} className="w-full px-6 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-indigo-500 focus:bg-white outline-none font-bold transition-all appearance-none">
                    ...
                    <div className="md:col-span-2 space-y-2">
                      ...
                      <textarea name="description" value={store.description || ''} onChange={handleInputChange} rows={5} className="w-full px-6 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-indigo-500 focus:bg-white outline-none font-bold transition-all resize-none" placeholder="Tell customers about your pet shop..."></textarea>
                    </div>
                    {/* Location Intel */}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            className="w-full px-6 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-indigo-500 focus:bg-white outline-none font-bold transition-all appearance-none"
                          >
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            className="w-full px-6 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-indigo-500 focus:bg-white outline-none font-bold transition-all appearance-none disabled:opacity-50 cursor-pointer"
                          >
                        ...
                        <div className="md:col-span-3 space-y-2">
                          ...
                          <input
                            ...
                            className="w-full px-6 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-indigo-500 focus:bg-white outline-none font-bold transition-all"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {['facebook', 'instagram', 'twitter', 'youtube'].map(s => (
                      <div key={s} className="space-y-2">
                        ...
                        <input type="text" value={store.socialMedia?.[s] || ''} onChange={(e) => handleSocialChange(s, e.target.value)} className="w-full px-6 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-indigo-500 focus:bg-white outline-none font-bold transition-all" />
                      </div>
                    ))}
                  </div>
                </div>
