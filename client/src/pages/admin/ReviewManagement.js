                                                ...
                                                {replyingTo === review._id ? (
                                                    <div className="space-y-3 animate-in fade-in slide-in-from-top-4">
                                                        ...
                                                        <div className="flex gap-3">
                                                            <button
                                                                ...
                                                                className="px-8 py-3.5 bg-slate-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-primary-600 transition-all disabled:opacity-50"
                                                            >
                                                                {submittingReply ? 'Sending...' : 'Transmit Reply'}
                                                            </button>
                                                            <button
                                                                onClick={() => setReplyingTo(null)}
                                                                className="px-8 py-3.5 bg-slate-100 text-slate-400 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-200 transition-all"
                                                            >
                                                                Cancel
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-3">
                                                        <button
                                                            ...
                                                            className="flex items-center gap-2 px-6 py-3.5 bg-slate-50 text-slate-500 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-primary-600 hover:text-white transition-all shadow-sm"
                                                        >
                                                            <Reply className="h-4 w-4" /> Reply to Review
                                                        </button>
                                                        <button
                                                            onClick={() => handleToggleStatus(review._id)}
                                                            className={`flex items-center gap-2 px-6 py-3.5 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-sm ${review.isApproved ? 'bg-slate-50 text-slate-500 hover:bg-rose-500 hover:text-white' : 'bg-rose-50 text-rose-500 hover:bg-emerald-500 hover:text-white'}`}
                                                        >
