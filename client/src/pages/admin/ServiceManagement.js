                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea required value={formData.description} onChange={e => setFormData(p => ({ ...p, description: e.target.value }))}
                          className="w-full px-8 py-6 bg-slate-50 border border-slate-100 rounded-[2.5rem] text-[13px] font-medium leading-relaxed outline-none h-40 resize-none shadow-inner" placeholder="WHAT DOES THIS SERVICE INCLUDE? DETAIL THE EXPERIENCE..." />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea value={formData.requirements} onChange={e => setFormData(p => ({ ...p, requirements: e.target.value }))}
                      className="w-full px-8 py-8 bg-slate-50 border border-slate-100 rounded-[2.5rem] text-[12px] font-medium leading-relaxed h-44 resize-none outline-none shadow-inner"
