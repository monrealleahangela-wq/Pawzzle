  ...
  return (
    <div className="min-h-screen bg-slate-50/30 p-4 lg:p-8 space-y-10 pb-32">
      ...
      {orders.length === 0 ? (
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="md:hidden space-y-4">
            {orders.map((order) => (
              <div key={order._id} className="bg-white p-5 rounded-[1.5rem] border border-slate-100 shadow-sm space-y-4 relative overflow-hidden">
      ...
      {pagination.totalPages > 1 && (
        <div className="relative z-10 flex justify-between items-center bg-slate-900 p-4 rounded-[1.5rem] border border-slate-800 mt-12 shadow-2xl">
          <button
