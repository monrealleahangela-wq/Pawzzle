  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Activity Log */}
        <div className="bg-white border border-slate-100 rounded-xl p-8 shadow-sm h-fit">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest flex items-center gap-2">
          ...
          <Link to="/superadmin/activity-history" className="w-full mt-10 py-3 bg-slate-50 hover:bg-slate-100 rounded-xl text-[9px] font-black text-slate-400 uppercase tracking-widest transition-all flex items-center justify-center">
