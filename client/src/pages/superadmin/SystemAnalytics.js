          ...
          <div className="space-y-4">
            {recentActivity.map((activity, i) => (
              <div key={i} className="flex items-center gap-4 group cursor-help">
                <div className={`w-8 h-8 rounded-2xl bg-${activity.color}-50 text-${activity.color}-600 flex items-center justify-center shrink-0 border border-${activity.color}-100 transition-transform group-hover:scale-110`}>
