                    ...
                    <div className="space-y-4">
                        {recommendations.map((rec, i) => (
                            <div key={i} className={`${cardClass} border-l-8 ${rec.type === 'critical' ? 'border-l-rose-500' : rec.type === 'warning' ? 'border-l-secondary-500' : 'border-l-indigo-500'}`}>
                                ...
                                <div className="py-2.5 px-4 bg-slate-50 rounded-2xl text-[9px] font-black uppercase tracking-widest text-slate-400 text-center">
                            ...
                            {monthlyRevenue.map((m, i) => (
                                <div key={i} className="flex-1 flex flex-col items-center gap-3 h-full justify-end group">
                                    <div className="relative w-full">
                                        <div 
                                            className="w-full bg-slate-100 group-hover:bg-primary-600 transition-all rounded-2xl"
