                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-100">
                                <th className="px-8 py-3 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Customer</th>
                                <th className="px-8 py-3 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Store</th>
                                <th className="px-8 py-3 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Service</th>
                                <th className="px-8 py-3 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Time</th>
                                    ...
                                    <tr key={b._id} className="hover:bg-slate-50 transition-colors group">
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <button
                                                ...
                                                className="p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-slate-900 hover:text-white transition-all group-hover:scale-110 active:scale-90"
                                            >
                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 z-[100] animate-fade-in">
                    <div className="bg-white rounded-[3rem] max-w-5xl w-full shadow-2xl relative overflow-hidden max-h-[90vh] flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto p-10 space-y-10 no-scrollbar">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="bg-primary-900 rounded-xl p-10 text-white relative overflow-hidden shadow-2xl">
                                            ...
                                            <div className="grid grid-cols-1 gap-3">
                                                {selectedBooking.service?.requirements ? (
                                                    selectedBooking.service.requirements.split(',').map((req, index) => (
                                                        <div key={index} className="flex items-center gap-4 p-4 bg-white/5 border border-white/10 rounded-xl group hover:bg-white/10 transition-all">
                        ...
                        <div className="p-8 bg-slate-50 border-t border-slate-100 relative z-10 flex gap-4">
                            <button
                                onClick={() => setSelectedBooking(null)}
                                className="flex-1 py-3 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-primary-600 transition-all shadow-xl"
                            >
                                Close
                            </button>
                        </div>
