                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-100">
                                ...
                                <th className="px-8 py-3.5 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Store</th>
                                <th className="px-8 py-3.5 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Service</th>
                                <th className="px-8 py-3.5 text-left text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Time</th>
                        ...
                        <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-white relative z-10">
                            <div>
                                <div className="flex items-center gap-2 mb-0.5">
                                    ...
                                    <span className="text-[8px] font-black text-primary-600 uppercase tracking-[0.4em] leading-none">Booking Details</span>
                                </div>
                                ...
                                <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest leading-none">Platform record details</p>
                            </div>
                            <button
