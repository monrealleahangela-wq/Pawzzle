...
const ReportManagement = () => {
    ...
    return (
        <div className="space-y-6 pb-20 p-4 lg:p-8 bg-slate-50/30 min-h-screen">
            ...
            <div className="bg-slate-900 p-2 rounded-2xl shadow-xl border border-slate-800 mb-6">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
                    <div className="md:col-span-6 relative group">
                        ...
                        <input
                            ...
                            className="w-full pl-28 pr-4 py-3.5 bg-slate-800 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl outline-none focus:ring-2 focus:ring-rose-500/50 placeholder:text-slate-600 transition-all font-sans"
                        />
                    </div>
                    <div className="md:col-span-3 relative">
                        ...
                        <select
                            ...
                            className="w-full h-full bg-slate-800 border-none text-white text-[10px] font-black uppercase tracking-widest rounded-2xl pl-28 pr-10 py-3.5 outline-none focus:ring-2 focus:ring-rose-500/50 appearance-none transition-all cursor-pointer font-sans"
                        >
