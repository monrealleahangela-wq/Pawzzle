                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
                    <div className="md:col-span-6 relative">
                        ...
                        <select
                            ...
                            className="w-full h-full bg-slate-800 border-none text-white text-[10px] font-black uppercase tracking-widest rounded-xl pl-12 pr-6 py-3 outline-none focus:ring-2 focus:ring-primary-500/50 appearance-none transition-all cursor-pointer font-sans"
                        >
                    ...
                    <div className="md:col-span-4 relative">
                        ...
                        <select
                            ...
                            className="w-full h-full bg-slate-800 border-none text-white text-[10px] font-black uppercase tracking-widest rounded-xl pl-12 pr-6 py-3 outline-none focus:ring-2 focus:ring-emerald-500/50 appearance-none transition-all cursor-pointer font-sans"
                        >
                                ...
                                <div className="flex flex-col md:flex-row md:items-start gap-6 sm:gap-10">
                                    ...
                                    <div className="flex md:flex-col gap-2 shrink-0">
                                        <button 
                                            ...
                                            className={`flex-1 md:flex-none p-3 rounded-xl transition-all shadow-sm ${item.status === 'reviewed' ? 'bg-primary-600 text-white' : 'bg-slate-50 text-slate-400 hover:bg-primary-600 hover:text-white'}`}
                                        >
                                            <CheckCircle className="h-5 w-5" />
                                        </button>
                                        <button 
                                            onClick={() => handleDelete(item._id)}
                                            className="flex-1 md:flex-none p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-rose-600 hover:text-white transition-all shadow-sm"
                                        >
