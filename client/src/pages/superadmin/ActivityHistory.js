        ...
        <div className="min-h-screen bg-slate-50/30 p-4 lg:p-8 space-y-8 pb-32">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-slate-100 pb-8">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <button onClick={fetchAllData} className="p-4 bg-white border border-slate-100 text-slate-400 rounded-xl hover:text-indigo-600 hover:border-indigo-100 transition-all active:scale-95 shadow-sm">
                        <RefreshCw className="h-5 w-5" />
                    </button>
                    <div className="px-6 py-3 bg-indigo-600 text-white rounded-xl flex items-center gap-3 shadow-xl shadow-indigo-100">
                                ...
                                <tr key={i} className="hover:bg-slate-50/50 transition-colors group">
                                    <td className="px-8 py-8">
                                        <div className="flex items-center gap-4">
                                            <div className={`w-12 h-12 rounded-xl bg-${activity.color}-50 text-${activity.color}-600 flex items-center justify-center border border-${activity.color}-100 group-hover:scale-110 transition-transform`}>
