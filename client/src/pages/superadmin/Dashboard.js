  ...
  return (
    <div className="space-y-5 pb-24">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Panel title="Delivery network" subtitle="Platform-wide logistics performance"><div className="grid grid-cols-3 gap-2 text-center"><div className="rounded-xl bg-primary-50 p-2"><strong className="block text-lg text-primary-700">{number(deliveries.active)}</strong><span className="text-[10px] text-primary-700">Active</span></div><div className="rounded-xl bg-emerald-50 p-2"><strong className="block text-lg text-emerald-700">{number(deliveries.completed)}</strong><span className="text-[10px] text-emerald-700">Done</span></div><div className="rounded-xl bg-rose-50 p-2"><strong className="block text-lg text-rose-700">{number(deliveries.failed)}</strong><span className="text-[10px] text-rose-700">Failed</span></div></div><div className="mt-3 grid grid-cols-2 gap-2 text-xs"><p className="rounded-lg border border-slate-100 p-2 text-slate-500">Internal riders<strong className="block text-slate-900">{number(deliveries.internal)}</strong></p><p className="rounded-lg border border-slate-100 p-2 text-slate-500">Average time<strong className="block text-slate-900">{number(deliveries.averageMinutes)} min</strong></p></div></Panel>
      </section>
